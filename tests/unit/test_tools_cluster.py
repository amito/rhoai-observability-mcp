...
class TestClusterTools:
    ...
    async def test_get_events(self):
        ...
        self.openshift.get_events.return_value = [
            {"reason": "Pulled", "message": "Container image pulled", "type": "Normal", "count": 1, "object": "Pod/vllm-0", "timestamp": "2024-01-01"},
        ]
    ...
    async def test_get_node_status(self):
        ...
        self.openshift.get_nodes.return_value = [
            {"name": "gpu-node-1", "conditions": {"Ready": "True"}, "capacity": {"nvidia.com/gpu": "4"}, "allocatable": {"nvidia.com/gpu": "2"}},
        ]
    ...
    async def test_get_inference_services(self):
        ...
        self.openshift.get_inference_services.return_value = [
            {"metadata": {"name": "llama-service", "namespace": "vllm"}, "status": {"conditions": [{"type": "Ready", "status": "True"}]}},
        ]
